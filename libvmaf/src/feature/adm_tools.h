...
float adm_cm_s(const adm_dwt_band_t_s *src, const adm_dwt_band_t_s *dst, const float *obj,const adm_dwt_band_t_s *csf_a, int w, int h, int src_stride, int dst_stride, int csf_a_stride, double border_factor, int scale);
