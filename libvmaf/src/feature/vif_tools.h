...
void vif_statistic_s(const float *mu1_sq, const float *mu2_sq, const float *mu1_mu2,const float *obj, const float *xx_filt, const float *yy_filt, const float *xy_filt, float *num, float *den,
