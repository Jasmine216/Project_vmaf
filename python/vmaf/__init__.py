...
class ExternalProgramCaller(object):
    ...
    @staticmethod
    def call_vmafrc_single_feature(feature, yuv_type, ref_path, dis_path, w, h, log_file_path, logger=None, options=None,obj_path=None):
        return ExternalProgramCaller.call_vmafrc_multi_features(
            [feature], yuv_type, ref_path, dis_path, w, h, log_file_path, logger=logger, options={feature: options},obj_path=obj_path)

    @staticmethod
    def call_vmafrc_multi_features(features, yuv_type, ref_path, dis_path,w, h, log_file_path, logger=None, options=None,obj_path=None):

        # ./libvmaf/build/tools/vmaf_rc
        # --reference python/test/resource/yuv/src01_hrc00_576x324.yuv
        # --distorted python/test/resource/yuv/src01_hrc01_576x324.yuv
        # --width 576 --height 324 --pixel_format 420 --bitdepth 8
        # --attention resource/dataset/obj/Tennis_out.yuv
